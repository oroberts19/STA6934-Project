...
```{r}
auto_arima_fit<- auto.arima(reg_data[,"unemployment_total"], xreg = as.matrix(reg_data[,"share_youth_NEET"]))
...
```{r}
chosen_fit<- Arima(reg_data[,"unemployment_total"], order = c(1,1,0), xreg = as.matrix(reg_data[,"share_youth_NEET"]))
...
### Comparing Dynamic Regression Results with Classic  
