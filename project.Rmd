...
```{r}
plot(regression_data$share_youth_NEET, regression_data$unemployment_total, main = "Best Fit Line: Unemployment ~ Share of Youth NEET", xlab="Unemployment (%)", ylab="Share of Youth NEET (%) ")
abline(lm_fit)
```
